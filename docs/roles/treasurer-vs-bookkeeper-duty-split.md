...
| Oversee church credit/debit cards and manage issuance. | Finance Committee | Treasurer, Bookkeeper, Personnel Committee where accountability is involved | Card policy, individually approved access, limits, no-sharing controls, suspension, and review are financial-control decisions. | Which individually attributable card or controlled payment method should KBC use? |
