...
| `docs/roles/bookkeeper-financial-administrator-job-description.md` | Job description | Draft operational Bookkeeper / Financial Administrator duties, qualifications, software responsibilities, and accountability. | Draft | Personnel Committee, Finance Committee | Maybe | Is the role paid, volunteer, contractor, staff, or stipend-based? |
...
| `docs/communications/personnel-committee-packet.md` | Committee review packet | Provide Personnel Committee with situation summary, role split, draft Bookkeeper materials, Finance recommendation, and discussion questions. | Draft | Personnel Committee, Finance Committee | No | What parts should be approved for sending to Finance Committee? |
| `docs/communications/personnel-committee-recommendation.md` | Communication draft | Recommend that Finance Committee provide direction on software, spending, reimbursement, card use, review, compensation, and role division. | Draft | Personnel Committee, Finance Committee | No | Has Personnel Committee approved sending this to Finance Committee? |
...
| File name | Type of document | Purpose | Current status | Related committee/body | Operations Manual | Open questions |
| --- | --- | --- | --- | --- | --- | --- |
| `source-materials/bylaws/Constitution, Bylaws, and Covenant 2018.pdf` | Bylaws / covenant source | Provide current governance authority for officer, committee, and church approval questions. | Imported source reference | Congregation, Pastor, Deacons, Nominating Committee, Finance Committee, Personnel Committee | Maybe | Confirm this is the current authoritative bylaws version. |
