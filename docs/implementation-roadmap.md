...
| 30-day plan | Clarify responsibilities and committee direction. | Finance Committee, Personnel Committee | Duty split, review packets, and first-round committee decisions. |
| 60-day plan | Choose operating model and prepare implementation materials. | Finance Committee | Software recommendation, policy drafts, role recommendations, and budget impact review. |
| 90-day plan | Begin implementation and monthly operating rhythm. | Finance Committee, Treasurer, Bookkeeper if approved | Software/setup plan, monthly review rhythm, role launch, and reporting process. |
...
| Open questions | Which Treasurer duties are required by bylaws? Should bookkeeping work be separate from elected Treasurer responsibilities? Does a paid or volunteer Bookkeeper role need church approval? What direction should Finance give Personnel before job materials are finalized? |
...
- [ ] Confirm whether Treasurer / Financial Officer and Bookkeeper / Financial Administrator should be separate roles.
...
| Deliverables | Software requirements approved for demos; completed demo scorecards; recommended software direction; draft reimbursement, spending authority, credit card/payment, monthly review, and audit/review policies; Bookkeeper role recommendation and budget impact estimate. |
...
- [ ] Personnel Committee refines Bookkeeper job description and application based on Finance direction.
...
| Supporting bodies | Personnel Committee, Bookkeeper / Financial Administrator if approved, Pastor, Deacons, outside vendor. |
...
- [ ] Launch Bookkeeper / Financial Administrator role if approved.
...
- Should the Bookkeeper / Financial Administrator role be volunteer, paid staff, contractor, or stipend-based?
...
Needs Review: This roadmap should be reviewed by Finance Committee, Personnel Committee, Pastor, Deacons, and any other body required by KBC bylaws or church practice.
