...
BOOKKEEPER_SRC="docs/roles/bookkeeper-financial-administrator-job-description.md"
...
main() {
  ...
  check_source "${BOOKKEEPER_SRC}"
  check_tools

  printf 'Exporting KBC review artifacts...\n'
  printf 'Only selected Markdown source files are exported. Confidential source materials are not included.\n\n'
  ...
  export_document "${BOOKKEEPER_SRC}" "bookkeeper-financial-administrator-job-description"
  export_slides
