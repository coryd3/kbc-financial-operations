...
KBC is in a Treasurer transition, and interim Treasurer coverage is helping necessary financial work continue while leadership reviews the longer-term structure.
...
The remaining work is to finalize the job description, application, hiring process, supervision and evaluation process, employment classification, and Finance Committee input on duties, controls, access, software, budget adjustment, and budget impact.

> **Main Recommendation**
>
> Move from authorization to implementation. The Treasurer / Financial Officer should remain an accountable elected role focused on review, reporting, stewardship, and Finance Committee coordination. The Personnel Committee should proceed toward hiring the authorized paid Bookkeeper / Financial Administrator after Finance Committee confirms the financial duties, controls, access, software, and budget impact. Nominating Committee should coordinate with Personnel Committee as named in the motion. Finance Committee should own financial process decisions and the budget adjustment assigned by the motion. Personnel Committee should own the people and hiring process.
...
- On June 28, 2026, the congregation authorized adding a paid, part-time Bookkeeper position not to exceed `$150` per week.
...
- Leadership now needs to move from general authorization to a clear job description, application, hiring process, budget adjustment, and financial control structure.
...
- Personnel Committee has authority to hire the right candidate, but still needs Finance Committee input before finalizing duties, access, controls, software responsibilities, and budget impact.
...
| Bookkeeper role | Personnel Committee | Nominating Committee coordinates as named in the motion; Finance Committee defines financial duties, controls, access, software responsibilities, and budget impact | Congregation authorized a paid, part-time Bookkeeper position on June 28, 2026, not to exceed `$150` per week. |
...
- What qualifications, application process, interview process, references, background-check process, and candidate evaluation process should apply?
...
- What employment classification, supervision plan, evaluation process, and start date should be used within the authority granted by the congregation?
...
- Do the job description, hiring process, hours, compensation, and budget adjustment stay within the June 28, 2026 motion?
...
The congregation has already authorized adding a paid, part-time Bookkeeper position not to exceed `$150` per week. The following items may still require church approval depending on bylaws, budget, policy, vote limits, or church practice:
...
| Bookkeeper / Financial Administrator hiring | Provides role and workflow input; may participate in interviews if assigned. | Applicant or role holder; no approval role. | Personnel Committee leads hiring process; Nominating Committee coordinates as named in the motion; Finance Committee defines duties, controls, budget impact, and reporting needs. | Congregation authorized a paid, part-time Bookkeeper position on June 28, 2026; additional vote only if scope, compensation, or budget exceeds the authorization. |
...
Needs Bylaw Review: Confirm each ownership area with KBC Constitution and Bylaws, committee charters, church practice, and the June 28, 2026 motion before treating this appendix as authoritative.
