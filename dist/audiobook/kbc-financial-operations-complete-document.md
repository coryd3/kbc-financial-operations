...
This compiled document gathers the current Markdown documentation in the same general order as the documentation site. The repository Markdown files remain the source of truth.
...
- Home: `docs/index.md`
- Leader-Friendly Dashboard: `docs/start-here/project-dashboard.md`
...
- Treasurer vs. Bookkeeper Duty Split: `docs/roles/treasurer-vs-bookkeeper-duty-split.md`
...
This dashboard tracks the major working documents in the KBC financial operations repository.

Status labels used here:

- Ready for review
- Needs committee input
- Needs Finance input
- Needs Personnel input
- Needs bylaw review
...
| Document | Purpose | Owner | Status | Review needed by | Priority | Notes |
| --- | --- | --- | --- | --- | --- | --- |
| `docs/communications/leadership-review-packet.md` | Summarize the overall situation, diagnosis, structure, decisions, roadmap, and risks for leadership. | Pastor / leadership team | Ready for review | Pastor, Deacons, Finance Committee, Personnel Committee | High | Use to align leaders before committee or church action. |
| `docs/00-project-brief.md` | State the purpose, current situation, deeper issue, and desired future state. | Project lead TBD | Ready for review | Pastor, Deacons, Finance Committee, Personnel Committee | High | Good orientation document for new reviewers. |
| `docs/01-current-state-assessment.md` | Summarize current gaps in roles, committee ownership, manual processes, software, spending, budget, and documentation. | Project lead TBD | Needs committee input | Finance Committee, Personnel Committee | High | Should be validated before being used publicly. |
| `docs/implementation-roadmap.md` | Organize immediate, 30-day, 60-day, 90-day, and long-term manual integration work. | Finance Committee / project lead TBD | Needs committee input | Finance Committee, Personnel Committee, Pastor, Deacons | High | Useful for sequencing decisions. |
| `docs/document-inventory.md` | Inventory active drafts, templates, and source materials. | Document owner TBD | Ready for review | Project lead / document maintainer | Medium | Keep updated as documents are added or retired. |
| `docs/document-workflow-upgrade-notes.md` | Capture lessons from the prior Personnel Committee repository and recommended workflow improvements. | Project lead TBD | Ready for review | Personnel Committee, document maintainers | Medium | Notes what to keep, what to improve, and what sensitive material should stay out of this repo. |
| `docs/project-dashboard.md` | Track major documents, owners, statuses, review needs, priority, and notes. | Project lead TBD | Ready for review | Pastor, Deacons, Finance Committee, Personnel Committee | High | Should be updated after committee decisions. |
| `docs/02-decision-log.md` | Record decisions, owners, status, and notes. | Project lead TBD | Needs committee input | Finance Committee, Personnel Committee, Nominating Committee | High | June 28, 2026 Bookkeeper authorization has been recorded; confirm against official minutes. |
| `docs/03-open-questions.md` | Track unresolved questions for committees, leadership, congregation, and professional review. | Project lead TBD | Needs committee input | All reviewers | High | Should drive meeting agendas; role creation is authorized, but details still need answers. |
| `docs/governance/constitution-and-bylaws-reference.md` | Provide quick access to the 2018 Constitution, Bylaws, and Covenant source and key review questions. | Church / Clerk TBD | Needs bylaw review | Pastor, Deacons, Finance Committee, Personnel Committee, Nominating Committee | High | Confirm this is the current authoritative version before relying on it for final decisions. |
| `docs/governance/church-organization-chart.md` | Show a draft church governance and financial-operations org chart. | Pastor / leadership team | Needs bylaw review | Pastor, Deacons, Finance Committee, Personnel Committee, Nominating Committee | High | Clarifies authority, committee lanes, and coordination lines without treating them as final. |
| `docs/governance/responsibility-matrix.md` | Clarify ownership among Treasurer, Bookkeeper, Finance, Personnel, Nominating, Pastor, Deacons, and Congregation. | Finance Committee | Needs bylaw review | Finance Committee, Personnel Committee, Nominating Committee, Pastor, Deacons | High | Reflects June 28 Bookkeeper authorization, Personnel hiring authority, Nominating coordination, and Finance budget-adjustment responsibility; still needs bylaw/practice check. |
| `docs/governance/finance-committee-charter.md` | Define Finance Committee purpose, responsibilities, monthly review, software ownership, and reporting. | Finance Committee | Needs bylaw review | Finance Committee, Pastor, Deacons | High | Needs confirmation against bylaws and church practice. |
| `docs/governance/personnel-committee-role.md` | Clarify Personnel Committee role in finance-related staffing and evaluations. | Personnel Committee | Needs Personnel input | Personnel Committee, Nominating Committee, Finance Committee | Medium | Should document how Personnel will use the already-granted hiring authority and coordinate with Nominating under the motion. |
| `docs/roles/treasurer-vs-bookkeeper-duty-split.md` | Compare current Treasurer duties with proposed Treasurer, Bookkeeper, committee, and vendor responsibilities. | Finance Committee | Needs committee input | Finance Committee, Personnel Committee, Nominating Committee | High | Core document for role separation. |
| `docs/roles/treasurer-governance-role.md` | Draft governance-focused Treasurer / Financial Officer role. | Finance Committee | Needs bylaw review | Finance Committee, Nominating Committee, Personnel Committee | High | Must align with bylaws before adoption. |
| `docs/roles/interim-treasurer-role.md` | Define temporary Treasurer coverage expectations. | Finance Committee | Needs bylaw review | Finance Committee, Nominating Committee, Pastor, Deacons | High | Should be clarified during stabilization. |
| `docs/roles/bookkeeper-financial-administrator-job-description.md` | Draft operational paid Bookkeeper / Financial Administrator role. | Personnel Committee | Needs Finance input | Personnel Committee, Nominating Committee, Finance Committee | High | Authorized role with $150/week limit; Personnel needs Finance direction on duties, access, controls, and budget impact before posting/final hiring. |
| `docs/roles/job-description-consistency-check.md` | Compare the Bookkeeper job description with prior KBC job-description patterns. | Personnel Committee | Needs Personnel input | Personnel Committee | Medium | Use to decide whether this format should become the standard for future KBC job descriptions. |
| `docs/roles/bookkeeper-hiring-process.md` | Draft hiring checklist, interview guide, reference questions, and candidate rubric for the authorized Bookkeeper role. | Personnel Committee | Needs Personnel input | Personnel Committee, Finance Committee, Pastor | High | Adapted from prior KBC Custodian hiring materials; Finance should confirm duties and controls before interviews. |
| `docs/roles/bookkeeper-job-application.md` | Draft application for paid Bookkeeper / Financial Administrator. | Personnel Committee | Needs Personnel input | Personnel Committee | High | Needs final screening, confidentiality, background-check, classification, and hiring-process language. |
| `docs/communications/personnel-committee-packet.md` | Give Personnel Committee a review packet for authorized paid Bookkeeper materials. | Personnel Committee | Ready for review | Personnel Committee | High | Good starting point for finalizing job description, application, hiring process, and compensation. |
| `docs/communications/finance-committee-packet.md` | Give Finance Committee a review packet for software, policy, budget, and monthly review decisions. | Finance Committee | Ready for review | Finance Committee | High | Good starting point for Finance discussion. |
| `docs/communications/personnel-committee-recommendation.md` | Draft request from Personnel to Finance for financial-duty direction. | Personnel Committee | Needs Personnel input | Personnel Committee | High | Should be approved before sending to Finance so hiring materials can be finalized. |
| `docs/communications/finance-committee-recommendation.md` | Placeholder for Finance Committee recommendation. | Finance Committee | Needs Finance input | Finance Committee | Medium | Parking content is still mostly TBD. |
| `docs/communications/church-business-meeting-summary.md` | Short plain-spoken summary for congregation. | Pastor / leadership team | Ready for review | Pastor, Deacons, Finance Committee, Personnel Committee | High | Use only after leadership review. |
| `docs/communications/deacon-update.md` | Placeholder update for Deacons. | Pastor / leadership team | Parking lot | Deacons, Pastor | Low | Needs actual decision or counsel request. |
| `docs/software-evaluation/software-requirements.md` | Define requirements before evaluating systems. | Finance Committee | Needs Finance input | Finance Committee, Treasurer, Bookkeeper | High | Should be approved before demos. |
| `docs/software-evaluation/demo-scorecard.md` | Score IconCMO and ChurchTrac demos by workflow. | Finance Committee | Needs Finance input | Finance Committee, Treasurer, Bookkeeper | High | Ready to use once demo participants and weights are set. |
| `docs/software-evaluation/icon-vs-churchtrac-comparison.md` | Compare IconCMO and ChurchTrac using confirmed information. | Finance Committee | Needs Finance input | Finance Committee | High | Do not fill vendor claims until confirmed. |
| `docs/software-evaluation/implementation-plan.md` | Outline implementation phases after software selection. | Finance Committee | Parking lot | Finance Committee | Medium | More useful after software direction is chosen. |
| `docs/policies/reimbursement-policy.md` | Draft reimbursement principles, documentation, and pre-approval triggers. | Finance Committee | Needs Finance input | Finance Committee | High | Needs thresholds, approvers, and timing. |
| `docs/procedures/reimbursement-process.md` | Step-by-step reimbursement process with exceptions and missing receipt handling. | Finance Committee | Needs Finance input | Finance Committee, Treasurer, Bookkeeper | High | Should follow approved reimbursement policy. |
| `docs/policies/spending-authority-policy.md` | Draft spending categories, thresholds, and approval paths. | Finance Committee | Needs bylaw review | Finance Committee, Pastor, Deacons | High | Thresholds and church vote triggers are TBD. |
| `docs/policies/credit-card-policy.md` | Draft controlled payment/card policy. | Finance Committee | Needs Finance input | Finance Committee, Treasurer, Pastor | High | Needs decision on shared debit cards vs assigned cards or other method. |
| `docs/policies/monthly-financial-review-policy.md` | Define monthly financial review purpose and items. | Finance Committee | Needs Finance input | Finance Committee, Treasurer | High | Should be strengthened after monthly packet is approved. |
| `docs/procedures/monthly-finance-committee-meeting-checklist.md` | Recurring checklist for monthly Finance Committee review. | Finance Committee | Ready for review | Finance Committee, Treasurer, Bookkeeper | High | Practical tool for immediate use. |
| `docs/policies/offering-counting-and-deposit-policy.md` | Draft offering counting and deposit controls. | Finance Committee | Needs Finance input | Finance Committee, Treasurer, Bookkeeper | Medium | Needs current practice details. |
| `docs/procedures/contribution-entry-process.md` | Draft contribution entry process. | Finance Committee | Needs Finance input | Finance Committee, Treasurer, Bookkeeper | Medium | Depends on software and donor confidentiality decisions. |
| `docs/procedures/weekly-bookkeeping-checklist.md` | Draft weekly bookkeeping checklist. | Finance Committee | Needs Finance input | Finance Committee, Treasurer, Bookkeeper | Medium | Needs current workflow validation. |
| `docs/procedures/monthly-close-checklist.md` | Draft monthly close checklist. | Finance Committee | Needs Finance input | Finance Committee, Treasurer, Bookkeeper | Medium | Depends on software and monthly packet decisions. |
| `docs/procedures/business-meeting-report-process.md` | Draft process for preparing business meeting financial reports. | Finance Committee | Needs committee input | Finance Committee, Pastor, Congregation if needed | Medium | Should align with monthly review and church expectations. |
| `docs/policies/audit-and-review-policy.md` | Draft audit/review expectations. | Finance Committee | Needs professional review | Finance Committee, CPA/accounting advisor if used | Medium | Scope and reviewer type still need direction. |
| `docs/procedures/payroll-process.md` | Draft payroll coordination process. | Finance Committee | Needs professional review | Finance Committee, Personnel Committee, payroll/accounting advisor | Medium | Payroll/tax details should not be finalized without professional input. |

#### Source Material References

| Document | Purpose | Owner | Status | Review needed by | Priority | Notes |
| --- | --- | --- | --- | --- | --- | --- |
| `source-materials/bylaws/Constitution, Bylaws, and Covenant 2018.pdf` | Current bylaws/covenant source for officer and approval questions. | Church / Clerk TBD | Needs bylaw review | Pastor, Deacons, Nominating Committee, Finance Committee, Personnel Committee | High | Surfaced in the site through `docs/governance/constitution-and-bylaws-reference.md`; confirm this is the current authoritative version. |
| `source-materials/existing-job-descriptions/final-approved/KBC_Treasurer_Job_Description_Rev_Nov2025.pdf` | Current approved Treasurer job description source. | Personnel Committee | Needs committee input | Personnel Committee, Finance Committee, Nominating Committee | High | Key source for duty split discussion. |
| `source-materials/existing-job-descriptions/accountability-frameworks/4_Treasurer Evaluation & Accountability Framework.docx` | Treasurer evaluation source. | Personnel Committee | Needs Personnel input | Personnel Committee, Finance Committee | Medium | Determine whether this is approved, draft, or superseded. |
| `source-materials/prior-proposals/treasurer/KBC Treasurer - Alternative Proposal 010926.pdf` | Prior Treasurer structure proposal. | Finance Committee / Personnel Committee | Needs committee input | Finance Committee, Personnel Committee | Medium | Mine for useful ideas after leadership direction. |
| `source-materials/prior-proposals/miller-management/The Kingsville Baptist Church Proposal-Level 1 Accounting - with QuickBooks.pdf` | Outsourced accounting / QuickBooks proposal source. | Finance Committee | Needs Finance input | Finance Committee | Medium | Review only after software/vendor requirements are set. |
| `source-materials/prior-proposals/finance/July 20th, 2025 budget meeting handout.pdf` | Prior budget meeting source. | Finance Committee | Needs Finance input | Finance Committee | Medium | Use for context, not as current policy. |

#### Dashboard Notes

- `Ready for review` means the document is ready for the named body to read and discuss, not approved.
...
| `docs/project-dashboard.md` | Project dashboard | Track major documents by purpose, owner, status, reviewer, priority, and notes. | Draft | Pastor, Deacons, Finance Committee, Personnel Committee, project lead | No | Who owns dashboard updates after committee meetings? |
...
| `docs/03-open-questions.md` | Open questions tracker | Track questions for Personnel, Finance, Nominating, Deacons, Pastor, Congregation, and professional review. | Draft | All project reviewers | No | Which questions must be answered before any church vote? |
...
| `docs/procedures/weekly-bookkeeping-checklist.md` | Procedure / checklist | Provide repeatable weekly bookkeeping steps. | Draft | Bookkeeper, Treasurer, Finance Committee | Yes | What exact weekly tasks are performed today? |
| `docs/procedures/monthly-close-checklist.md` | Procedure / checklist | Provide repeatable month-end close steps and report preparation. | Draft | Bookkeeper, Treasurer, Finance Committee | Yes | What system reports and reconciliations are required each month? |
| `docs/procedures/monthly-finance-committee-meeting-checklist.md` | Procedure / checklist | Provide recurring monthly Finance Committee meeting checklist for income/expenses, budget, designated funds, cards, reimbursements, exceptions, votes, and business meeting reporting. | Draft | Finance Committee, Treasurer, Bookkeeper | Yes | Who prepares the packet, records decisions, and maintains the checklist? |
| `docs/procedures/payroll-process.md` | Procedure | Document payroll inputs, approval flow, provider/software steps, and records. | Draft | Personnel Committee, Finance Committee, Treasurer, Bookkeeper | Yes | Who owns payroll changes, approvals, and professional review? |
| `docs/procedures/contribution-entry-process.md` | Procedure | Document contribution entry, total matching, discrepancies, confidentiality, and reporting. | Draft | Finance Committee, Treasurer, Bookkeeper | Yes | Who enters contributions today, and how is donor confidentiality protected? |
...
| `docs/procedures/business-meeting-report-process.md` | Procedure | Define preparation and communication of financial reports for church business meetings. | Draft | Finance Committee, Treasurer, Pastor, Congregation | Yes | What report format does the congregation expect or require? |
| `docs/software-evaluation/software-requirements.md` | Requirements | Define software requirements before selecting ChurchTrac, IconCMO, QuickBooks, or another system. | Draft | Finance Committee, Treasurer, Bookkeeper | Maybe | Which requirements are must-have before demos? |
...
- Lead the hiring process for the paid Bookkeeper / Financial Administrator role already authorized by congregational vote.
- Coordinate with Nominating Committee as needed under the June 28, 2026 motion to add the paid, part-time Bookkeeper position.
- Coordinate with finance committee on role boundaries and accountability.

#### Open Items

- Confirm the official minutes for the June 28, 2026 motion and the coordination expected between Personnel Committee and Nominating Committee.
- Confirm that final compensation and hours remain within the authorization of not more than `$150` per week, described as `$18.75` per hour for approximately 8 hours.
...
Needs Bylaw Review: The June 28, 2026 authorization, changes to elected Treasurer responsibilities, compensation beyond the approved limit, and any remaining church vote requirements should be checked against KBC Constitution and Bylaws and church practice.
...
Define controls for counting, recording, and depositing offerings.

#### Policy

- Minimum counters:
- Count sheet requirements:
- Deposit timing:
- Contribution entry:
- Reconciliation:

Needs Finance Review: Finance Committee should confirm cash-handling controls, counter requirements, deposit authority, documentation, reconciliation process, and access to contribution records before adoption.

Needs Bylaw Review: Final approval path and any officer or committee responsibilities should be checked against KBC Constitution and Bylaws and church practice.
...
Document how contributions are entered, reviewed, corrected, and reported.

#### Steps

1. Receive count sheets and deposit records.
2. Enter contributions into the approved system.
3. Confirm totals match deposit records.
4. Resolve discrepancies.
5. Maintain donor confidentiality.
6. Prepare contribution reports as authorized.
...
Define how financial reports are prepared and communicated for church business meetings.

#### Steps

1. Prepare report packet.
2. Treasurer and finance committee review.
3. Resolve questions or exceptions.
4. Present summary at business meeting.
5. Record motions, approvals, and follow-up items.
...
Document payroll responsibilities, approval flow, timing, records, and review steps.

#### Steps

1. Confirm approved compensation and changes.
2. Verify time or salary inputs.
3. Submit payroll through approved provider or system.
4. Record payroll entries.
5. File payroll reports and confirmations.
6. Review payroll totals during monthly close.
